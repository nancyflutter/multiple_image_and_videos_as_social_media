...
class GetRestaurantsDetailResponse {
  String? id;
  String? type;
  ...
  GetRestaurantsDetailResponse copyWith({
    String? id,
    String? type,
    Attributes? attributes,
    Relationships? relationships,
  ...
  factory GetRestaurantsDetailResponse.fromRawJson(String str) => GetRestaurantsDetailResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetRestaurantsDetailResponse.fromJson(Map<String, dynamic> json) => GetRestaurantsDetailResponse(
    id: json["id"],
    type: json["type"],
