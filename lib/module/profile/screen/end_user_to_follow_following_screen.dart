import 'package:multiple_image_and_videos_as_social_media/module/profile/controller/end_user_to_follow_following_controller.dart';
import '../../../core/core.dart';

class EndUserToFollowFollowingScreen extends StatelessWidget {
  const EndUserToFollowFollowingScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetX(
      init: EndUserToFollowFollowingController(),
      initState: (cnt) {
                                            ...
                                            children: [
                                              GestureDetector(
                                                onTap: () {
                                                  ...
                                                  // Get.toNamed(RoutesStrings.serviceDetailsRoute, arguments: {"userId": "${controller.followerList.value.responseData?[index].userId}"});
                                                },
                                                child: Row(
                                                  children: [
                                                    SizedBox(
