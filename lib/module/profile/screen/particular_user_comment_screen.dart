...
class ParticularUserCommentScreen extends StatelessWidget {
  const ParticularUserCommentScreen({super.key});
    ...
    return GetX<FavouritesScreenController>(
      ...
      builder: (controller) {
        if (Get.arguments != null) {
          controller.index.value = Get.arguments['index'];
          controller.postId.value = Get.arguments['postId'];
        }
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              Expanded(
                child: controller.postsCommentList.isNotEmpty
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        if (controller.sendMessageController.value.text.trim().isNotEmpty) {
                          ...
                          controller.addCommentsAPI(postId: postIdData, index: indexData);
                        } else {
