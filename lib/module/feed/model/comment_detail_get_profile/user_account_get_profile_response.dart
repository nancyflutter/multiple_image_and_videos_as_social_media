import 'dart:convert';
// UserAccountGetProfileResponse? responseData;

class UserAccountGetProfileResponse {
  String? fullName;
  String? email;
  String? bio;
  String? gender;
  ...
  UserAccountGetProfileResponse copyWith({
    String? fullName,
    String? email,
    String? bio,
    String? gender,
  ...
  factory UserAccountGetProfileResponse.fromRowJson(String str) => UserAccountGetProfileResponse.fromJson(json.decode(str));

  String toRowJson() => json.encode(toMap());

  factory UserAccountGetProfileResponse.fromJson(Map<String, dynamic> json) => UserAccountGetProfileResponse(
